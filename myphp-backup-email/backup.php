...
class Backup_Database {
    ...
    public function sendMail() {
        ...
        $mailPort = 654;
        $mailPass = "password";
        $sendToMail = "sender mail";
        $sendToName = "sender Name";
        $from = "sender email";
...
// Instantiation and passing `true` enables exceptions
        ...
        try {
            ...
            $mail->addAddress($sendToMail, $sendToName);     // Add a recipient
            // Attachments
            echo "backup file is $this->filePath";
            $mail->addAttachment($this->filePath);    // Optional name
            // Content
            $mail->isHTML(true);                                  // Set email format to HTML
            $mail->Subject = 'Database Backup';
            $mail->Body = '<b>Dear Find Server Backup|</b>';
            $mail->AltBody = 'Find the attached backup';
